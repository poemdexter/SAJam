...
function load_boat_sprites()
	boat.sprites.up_still = love.graphics.newImage("img/boat_up_still.png")
	boat.sprites.up_move_1 = love.graphics.newImage("img/boat_up_move_1.png")
	boat.sprites.up_move_2 = love.graphics.newImage("img/boat_up_move_2.png")
	
	boat.sprites.down_still = love.graphics.newImage("img/boat_down_still.png")
	boat.sprites.down_move_1 = love.graphics.newImage("img/boat_down_move_1.png")
	boat.sprites.down_move_2 = love.graphics.newImage("img/boat_down_move_2.png")
	
	boat.sprites.right_still = love.graphics.newImage("img/boat_right_still.png")
	boat.sprites.right_move_1 = love.graphics.newImage("img/boat_right_move_1.png")
	boat.sprites.right_move_2 = love.graphics.newImage("img/boat_right_move_2.png")
	boat.sprites.right_move_3 = love.graphics.newImage("img/boat_right_move_3.png")
	boat.sprites.right_move_4 = love.graphics.newImage("img/boat_right_move_4.png")
	boat.sprites.right_move_5 = love.graphics.newImage("img/boat_right_move_5.png")
